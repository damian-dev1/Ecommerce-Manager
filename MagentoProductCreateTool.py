...
class AdvancedMagentoToolPro:
    ...
    def _build_product_tab(self):
        ...
        # Categories
        self.cb_tree = CheckboxTree(self.cat_tab)
    ...
    def _connect_task(self):
        try:
            ...
            self.set_status("Fetching categories…")
            root_cat = self.api_client.get_category_tree()
            self._ui(self.cb_tree.build, root_cat)
